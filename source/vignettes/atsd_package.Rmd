...
**Description:**
 ...
 argument provides
 column of the data frame which is used as the index for the zoo object.
 The 
...
**Arguments:**
 ...
 Name or number of a column with time stamps. By default, 
 `timestamp = "Timestamp"`.
...
**Arguments:**
 ...
 - <tt><font color = "SaddleBrown">time_col</font></tt>&nbsp; (optional, numeric or character)   
  ...
  Read "Timestamps format" section below for suppported timestamp classes and formats.
 ...
 Specifies names of metrics. The series pointed by 
 ...
 Each indicated tag will be saved with each series. Witespace symbols are ignored.
...
**Time stamps format.**
 ...
 time zone has +09:30 shift relative to the GMT zone.
