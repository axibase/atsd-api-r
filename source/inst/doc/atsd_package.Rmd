...
**Arguments:**
 ...
 - <tt><font color = "SaddleBrown">time_col</font></tt>&nbsp; (optional, numeric or character)   
  Number or name of the column with timestaps. Default value is 1.
  For example, 
 ...
 By default, `tz = "GMT"`. Specify time zone, when time stamps 
 are strings formatted as setted in the 
 <tt><font color = "SaddleBrown">time_format</font></tt>&nbsp;
 argument.
 For example, `tz = "Australia/Darwin"`.
 Veiw the "TZ" column of [the time zones table](http://en.wikipedia.org/wiki/Zone.tab) for
...
**Time stamps format.**
 ...
 - String, for example, "2015-01-03 10:07:15". In that case 
 <tt><font color = "SaddleBrown">time_format</font></tt>&nbsp;
 ...
 For example, if you save time stamp `"2015-02-15 10:00:00"` with 
 `tz = "Australia/Darwin"` in ATSD, and then fetch it back, you will get time stamp 
...
**Entity specification**
 ...
 specified by 
 <tt><font color = "SaddleBrown">entity_col</font></tt>&nbsp; contains several entities,
...
**Tags specification**
 ...
 argument points which columns of the data frame
 keep tags of time series. The name of each column specified by the
 <tt><font color = "SaddleBrown">tags_col</font></tt>&nbsp;
